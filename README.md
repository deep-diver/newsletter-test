[![ci](https://github.com/deep-diver/newsletter-test/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/deep-diver/newsletter-test/actions/workflows/ci.yml) [![send_newsletter](https://github.com/deep-diver/newsletter-test/actions/workflows/newsletter.yml/badge.svg)](https://github.com/deep-diver/newsletter-test/actions/workflows/newsletter.yml)
...
1. Write a content to be included in newsletter in YAML format under `current` directory.
   - Examples can be found in [test](https://github.com/deep-diver/newsletter-test/tree/main/test) directory.
